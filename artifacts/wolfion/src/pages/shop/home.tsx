...
export default function ShopHome() {
  ...
  return (
    <ShopLayout>
      ...
      {/* 3A — BAPARI SOCKS · Engineered Comfort */}
      ...
      {/* 3B — COLLECTION · Everyday Essentials */}
      <section className="container mx-auto px-5 pb-28 sm:pb-32">
        <div className={`flex items-end justify-between mb-12 ${FADE}`}>
          <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 sm:gap-6">
          {[
            { href: "/products?collection=mens", img: imgPortrait, label: "Menswear" },
            { href: "/products?collection=womens", img: imgWomenswear, label: "Womenswear" },
            { href: "/products?collection=kids", img: imgKidswear, label: "Kidswear" },
          ].map((col, i) => (
            <Link
              key={col.label}
              href={col.href}
