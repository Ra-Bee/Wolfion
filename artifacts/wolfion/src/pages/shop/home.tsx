  ...
  return (
    <ShopLayout>
      ...
      <section className="relative h-[80vh] min-h-[520px] w-full overflow-hidden bg-black text-white">
        <img src={imgPortrait} alt="Ultion" className="absolute inset-0 h-full w-full object-cover opacity-80" />
        ...
        <div className="relative z-10 h-full container mx-auto px-5 flex flex-col justify-end pb-16">
          <div className="max-w-2xl">
            ...
            <p className="mt-6 text-base text-white/70 max-w-md font-light leading-relaxed">
              Ultion crafts essentials for the modern wardrobe — engineered fabrics, considered details, and a silhouette that stays sharp.
            </p>
      ...
      {/* Vaporyx — sock categories */}
      <section className="container mx-auto px-5 py-20">
        <div className="flex items-end justify-between mb-10">
          <div>
            <p className="text-xs uppercase tracking-[0.3em] text-neutral-500 mb-2">Ultion</p>
            <h2 className="text-3xl sm:text-4xl font-light tracking-tight">Vaporyx · Socks</h2>
          </div>
      ...
      {/* Collection — Menswear & Womenswear */}
      <section className="container mx-auto px-5 pb-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6">
          <Link href="/products?collection=mens" className="group relative block aspect-[16/10] rounded-2xl overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-500 hover:-translate-y-1">
            <img src={imgPortrait} alt="Menswear" className="absolute inset-0 h-full w-full object-cover transition-transform duration-700 group-hover:scale-105" />
            <div className="absolute inset-0 bg-gradient-to-t from-black/75 via-black/20 to-transparent" />
            <div className="absolute bottom-6 left-6 right-6 text-white">
              <p className="text-[11px] uppercase tracking-[0.35em] text-white/80 mb-2">Collection</p>
              <h3 className="text-2xl sm:text-3xl font-light">Menswear</h3>
          ...
          <Link href="/products?collection=womens" className="group relative block aspect-[16/10] rounded-2xl overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-500 hover:-translate-y-1">
            <img src={imgWomenswear} alt="Womenswear" className="absolute inset-0 h-full w-full object-cover transition-transform duration-700 group-hover:scale-105" />
            <div className="absolute inset-0 bg-gradient-to-t from-black/75 via-black/20 to-transparent" />
            <div className="absolute bottom-6 left-6 right-6 text-white">
              <p className="text-[11px] uppercase tracking-[0.35em] text-white/80 mb-2">Collection</p>
              <h3 className="text-2xl sm:text-3xl font-light">Womenswear</h3>
              <span className="inline-flex items-center mt-3 text-sm font-medium">
                Shop now <ArrowRight className="ml-2 h-4 w-4" />
              </span>
            </div>
