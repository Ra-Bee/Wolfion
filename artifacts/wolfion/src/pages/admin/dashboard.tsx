            ...
            {(() => {
              ...
              return (
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(135deg, rgba(74,222,128,0.65) 0%, rgba(190,235,210,0.2) 50%, rgba(74,222,128,0.55) 100%)",
                  }}
                >
                  <div
                    className="relative rounded-[22px] overflow-hidden p-4 sm:p-5 bg-emerald-50/70 dark:bg-emerald-950/55"
                    style={{
            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-2.5">
              {[
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(135deg, rgba(74,222,128,0.6) 0%, rgba(190,235,210,0.2) 50%, rgba(74,222,128,0.5) 100%)",
                  }}
                >
                  <div
                    className="relative rounded-[11px] overflow-hidden px-2 py-1.5 sm:px-2.5 sm:py-2 min-h-[48px] flex flex-col justify-center box-border bg-emerald-50/70 dark:bg-emerald-950/55"
                    style={{
            ...
            <div className="grid grid-cols-2 gap-2 sm:grid-cols-3 lg:grid-cols-5 lg:gap-3">
              {(() => {
                ...
                const ringByTone: Record<"green" | "amber", string> = {
                  green: "linear-gradient(135deg, rgba(74,222,128,0.65) 0%, rgba(190,235,210,0.2) 50%, rgba(74,222,128,0.55) 100%)",
                ...
                const haloByTone: Record<"green" | "amber", string> = {
                  green: "radial-gradient(circle, rgba(34,197,94,0.32) 0%, transparent 70%)",
                ...
                return tiles.map((tile) => (
                  ...
                  >
                    <div
                      className="relative rounded-[15px] overflow-hidden p-4 bg-emerald-50/70 dark:bg-emerald-950/55 h-full"
                      style={{
                        backdropFilter: "blur(22px) saturate(120%)",
                        WebkitBackdropFilter: "blur(22px) saturate(120%)",
                      }}
