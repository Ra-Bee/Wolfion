          ...
          <CardContent className="space-y-4">
            <form onSubmit={handleAddPurchase} className="grid gap-3 sm:grid-cols-3">
              ...
              <div className="space-y-2">
                ...
                <Input id="yp-kg" type="number" min="0" step="0.01" inputMode="decimal" className="h-12 text-base" placeholder="Example: 50" value={purchaseKg} onChange={(e) => setPurchaseKg(e.target.value)} required />
              </div>
