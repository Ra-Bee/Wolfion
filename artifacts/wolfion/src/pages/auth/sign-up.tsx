        ...
        <div className="relative z-10 flex h-full flex-col justify-between p-10">
          ...
          <div className="grid grid-cols-3 gap-3">
            <figure className="aspect-[3/4] rounded-2xl overflow-hidden ring-1 ring-white/10">
              <img src={imgPortrait} alt="Bapari Socks editorial" className="h-full w-full object-cover" />
            </figure>
            <figure className="col-span-2 aspect-[4/3] rounded-2xl overflow-hidden ring-1 ring-white/10">
              <img src={imgTees} alt="Bapari Socks tees" className="h-full w-full object-cover" />
            </figure>
          ...
          <div>
            <h2 className="text-3xl font-light leading-tight">
              Join the house of <span className="italic font-serif text-primary">Bapari Socks</span>.
            </h2>
      ...
      <main className="flex items-center justify-center px-4 py-12 relative overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-[400px] lg:mt-0 mt-32">
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-sm text-muted-foreground">Join Bapari Socks in under a minute</p>
          </div>
