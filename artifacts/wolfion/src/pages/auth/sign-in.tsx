      ...
      <aside className="relative hidden lg:block overflow-hidden bg-black text-white">
        ...
        <div className="relative z-10 flex h-full flex-col justify-between p-10">
          <div className="flex items-center gap-3">
            ...
            <span className="text-base font-semibold tracking-[0.22em] whitespace-nowrap">BAPARI SOCKS</span>
          </div>

          <div className="grid grid-cols-3 gap-3">
            <figure className="col-span-2 aspect-[4/3] rounded-2xl overflow-hidden ring-1 ring-white/10">
              <img src={imgSocks} alt="Bapari Socks collection" className="h-full w-full object-cover" />
            </figure>
            <figure className="aspect-[3/4] rounded-2xl overflow-hidden ring-1 ring-white/10">
              <img src={imgLogoEmbroidered} alt="Embroidered Bapari Socks logo" className="h-full w-full object-cover" />
            </figure>
            <figure className="col-span-3 aspect-[16/7] rounded-2xl overflow-hidden ring-1 ring-white/10">
              <img src={imgTees} alt="Bapari Socks apparel" className="h-full w-full object-cover" />
            </figure>
          </div>
          ...
          <div>
            ...
            <p className="mt-3 text-sm text-white/60 max-w-md">
              Welcome back to Bapari Socks — sign in to continue shopping the latest pieces from our collection.
            </p>
          </div>
        </div>
      </aside>
        ...
        <div className="relative z-10 w-full max-w-[400px] lg:mt-0 mt-32">
          <div className="flex flex-col items-center mb-8">
            <div className="h-16 w-16 rounded-2xl bg-black flex items-center justify-center shadow-lg shadow-primary/20 overflow-hidden">
              <img src={wolfionMark} alt="Bapari Socks" className="h-full w-full object-cover" />
            </div>
            <h1 className="mt-4 text-2xl font-semibold">Welcome back</h1>
            <p className="text-sm text-muted-foreground">Sign in to your Bapari Socks account</p>
          </div>
