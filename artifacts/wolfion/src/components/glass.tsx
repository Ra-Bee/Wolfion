...
const RING_GRADIENT =
  "linear-gradient(135deg, rgba(255,255,255,0.4) 0%, rgba(200,200,200,0.15) 50%, rgba(255,255,255,0.3) 100%)";

const HAIRLINE_GRADIENT =
  "linear-gradient(90deg, transparent 0%, rgba(255,255,255,0.3) 30%, rgba(200,200,200,0.3) 70%, transparent 100%)";

export function GlassAtmosphere({ className }: { className?: string }) {
  return (
    <div aria-hidden className={cn("pointer-events-none absolute inset-0 overflow-hidden", className)}>
      <div
        className="absolute -top-[15%] -left-[10%] h-[55vh] w-[55vh] rounded-full opacity-[0.05] blur-[120px]"
        style={{ background: "radial-gradient(circle, rgba(255,255,255,0.8) 0%, transparent 70%)" }}
      />
      <div
        className="absolute top-[30%] -right-[10%] h-[50vh] w-[50vh] rounded-full opacity-[0.05] blur-[110px]"
        style={{ background: "radial-gradient(circle, rgba(255,255,255,0.8) 0%, transparent 70%)" }}
      />
      <div
        className="absolute -bottom-[10%] left-[35%] h-[45vh] w-[45vh] rounded-full opacity-[0.03] blur-[110px]"
        style={{ background: "radial-gradient(circle, rgba(255,255,255,0.8) 0%, transparent 70%)" }}
      />
    </div>
  );
