...
import { Home as HomeIcon, Store, ShoppingBag, User, LogOut, LogIn, Search, ShieldCheck, ChevronDown, Menu, Settings, Mail, Info, X, Sun, Moon } from "lucide-react";
...
export function ShopLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-[100dvh] flex flex-col bg-white text-neutral-900 dark:bg-[#0a0a0a] dark:text-neutral-50 antialiased font-sans pb-16 md:pb-0">
      {/* 3D Glass header — elegant metallic minimal luxury */}
      <header
        className={`wf-shop-header safe-pt fixed top-0 z-40 w-full transition-all duration-300 ${
          headerScrolled
            ? "bg-white/45 dark:bg-neutral-950/45 backdrop-blur-md border-b border-white/40 dark:border-white/10"
        ...
        style={
          headerScrolled
            ? {
                boxShadow:
                  "inset 0 1px 0 rgba(255,255,255,0.55), 0 8px 24px -12px rgba(0,0,0,0.25)",
              }
            : undefined
        }
      >
        <div className="container mx-auto px-4 sm:px-6 h-11 md:h-14 flex items-center gap-3 sm:gap-6">
          {/* Mobile menu trigger */}
            ...
            <Sheet open={mobileMenuOpen} onOpenChange={setMobileMenuOpen}>
              <SheetTrigger asChild>
                <Button
                  ...
                  className="text-neutral-900 dark:text-white drop-shadow-[0_1px_2px_rgba(255,255,255,0.6)] dark:drop-shadow-[0_1px_3px_rgba(0,0,0,0.8)]"
              ...
              <SheetContent
                side="right"
                className="w-[62vw] max-w-[360px] p-0 flex flex-col bg-white/10 dark:bg-neutral-950/10 backdrop-blur-md [&>button]:hidden border-l border-white/40 dark:border-white/10"
                style={{
                  boxShadow:
              ...
              >
                ...
                <SheetHeader className="safe-pt-menu pt-3 px-2.5 pb-4 text-left border-b border-neutral-200/40 dark:border-white/10 bg-transparent">
                  <div className="relative flex items-center gap-1.5">
                    <div className="h-7 w-7 shrink-0 rounded-sm bg-black dark:bg-white flex items-center justify-center overflow-hidden shadow-sm">
                      <img src={imgLogoWhite} alt="Wolfion" className="h-full w-full object-contain p-0.5 dark:invert" />
                    </div>
                    <SheetTitle className="tracking-[0.18em] text-sm text-white font-serif uppercase" style={{ textShadow: "0 1px 4px rgba(0,0,0,0.9)" }}>
                      WOLFION
                    </SheetTitle>
                    {user ? null : (
                      <SheetClose asChild>
                        <Link href="/sign-in" className="ml-2">
                          <Button
                            variant="outline"
                            size="sm"
                            className="h-5 px-1.5 text-[9px] text-white border-white/40 bg-white/10 hover:bg-white/20 hover:text-white [text-shadow:0_1px_3px_rgba(0,0,0,0.8)]"
                            data-testid="menu-header-login"
                          >
                ...
                <nav className="flex-1 px-3 py-3 overflow-y-auto flex flex-col gap-4">
                  ...
                  <SheetClose asChild>
                    <Link href="/about">
                      <button className="menu-3d-item w-full flex items-center" data-testid="menu-about-mobile">
                        <Info className="mr-2.5 h-4 w-4" /> About
                      </button>
                    </Link>
                  </SheetClose>
                  <SheetClose asChild>
                    <Link href="/contact">
                      <button className="menu-3d-item w-full flex items-center" data-testid="menu-contact-mobile">
                        <Mail className="mr-2.5 h-4 w-4" /> Contact
                      </button>
                    </Link>
                  </SheetClose>
                  {isAdmin && (
                ...
                <SheetFooter className="border-t border-neutral-200 dark:border-neutral-800 p-4 flex-col gap-2 sm:flex-col">
                  {user ? (
                    <>
                      <div className="text-xs text-white px-2 truncate [text-shadow:0_1px_3px_rgba(0,0,0,0.8)]">
                        Signed in as {user?.emailAddresses[0]?.emailAddress}
                      </div>
                      <Button variant="outline" className="w-full justify-start text-white border-white/40 bg-white/10 hover:bg-white/20 hover:text-white [text-shadow:0_1px_3px_rgba(0,0,0,0.8)]" onClick={handleSignOut}>
                    ...
                    <SheetClose asChild>
                      <Link href="/sign-in" className="w-full">
                        <Button variant="outline" className="w-full justify-start text-white border-white/40 bg-white/10 hover:bg-white/20 hover:text-white [text-shadow:0_1px_3px_rgba(0,0,0,0.8)]" data-testid="menu-login-mobile">
          ...
          <Link href="/shop" className="flex items-center gap-2 flex-shrink-0" data-testid="link-logo">
            <div className="h-8 w-8 rounded-sm bg-black dark:bg-white flex items-center justify-center overflow-hidden shadow-sm">
              <img src={imgLogoWhite} alt="Wolfion" className="h-full w-full object-contain p-0.5 dark:invert" />
            </div>
            <span
              className="wf-brand-text font-serif uppercase tracking-[0.35em] text-sm sm:text-base whitespace-nowrap text-black dark:text-white"
            >
              WOLFION
            </span>
          </Link>
          ...
          <nav className="hidden md:flex items-center gap-7 lg:gap-10 flex-1 min-w-0">
            ...
            <div className="inline-flex items-center gap-1">
              <Link
                href="/shop#bapari-socks"
                className="text-[12px] uppercase tracking-[0.2em] font-medium whitespace-nowrap text-neutral-500 hover:text-neutral-900 dark:text-neutral-400 dark:hover:text-neutral-50 transition-colors outline-none"
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <button
                  className="inline-flex items-center text-neutral-500 hover:text-neutral-900 dark:text-neutral-400 dark:hover:text-neutral-50 transition-colors outline-none"
                  data-testid="nav-bapari-dropdown"
                  aria-label="Bapari Socks menu"
                >
          ...
          <div className="ml-auto flex items-center gap-1 sm:gap-2 flex-shrink-0">
            {isAdmin && (
              <Button
                ...
                variant="outline"
                onClick={switchToAdmin}
                className="inline-flex h-8 px-2 sm:px-3 text-[10px] sm:text-[11px] uppercase tracking-[0.12em] sm:tracking-[0.15em] font-medium border-neutral-300 dark:border-neutral-700 active:scale-95 transition-transform"
            ...
            <Button
              ...
              className={`active:scale-95 transition-transform ${isAdmin ? "hidden md:inline-flex" : ""}`}
            >
            ...
            <div className="hidden md:block">
              <Sheet open={accountMenuOpen} onOpenChange={setAccountMenuOpen}>
                ...
                <SheetContent side="right" className="w-[62vw] max-w-[360px] p-0 flex flex-col bg-white/10 dark:bg-neutral-950/10 backdrop-blur-md [&>button]:hidden">
                  <SheetHeader className="safe-pt-menu pt-3 px-2.5 pb-4 text-left border-b border-white/15">
                    <div className="relative flex items-center gap-1.5">
                      <div className="h-7 w-7 shrink-0 rounded-sm bg-black dark:bg-white flex items-center justify-center overflow-hidden shadow-sm">
                        <img src={imgLogoWhite} alt="Wolfion" className="h-full w-full object-contain p-0.5 dark:invert" />
                      </div>
                    ...
                    <p className="text-xs text-white/75 truncate pl-1" style={{ textShadow: "0 1px 3px rgba(0,0,0,0.9)" }}>
                      {user ? (user.fullName || user.emailAddresses[0]?.emailAddress) : "Account"}
                    </p>
                  </SheetHeader>
                  <nav className="flex-1 px-3 py-3 overflow-y-auto flex flex-col gap-3">
                    <SheetClose asChild>
                      <Link href="/shop">
                        <button className="menu-3d-item w-full flex items-center" data-testid="menu-home">
                          <HomeIcon className="mr-2.5 h-4 w-4" /> Home
                        </button>
                      </Link>
                    </SheetClose>
                    <SheetClose asChild>
                      <Link href="/products">
                        <button className="menu-3d-item w-full flex items-center" data-testid="menu-shop">
                          <Store className="mr-2.5 h-4 w-4" /> Shop
                        </button>
                      </Link>
                    </SheetClose>
                    ...
                    <Accordion type="multiple" className="w-full flex flex-col gap-3">
                      <AccordionItem value="bapari-r" className="border-none">
                        <AccordionTrigger className="menu-3d-item w-full !py-0 hover:no-underline" data-testid="menu-bapari">
                          Bapari Socks
                        </AccordionTrigger>
                        <AccordionContent className="pb-1 pt-3">
                          <div className="flex flex-col gap-2 pl-2">
                      ...
                      <AccordionItem value="collection-r" className="border-none">
                        <AccordionTrigger className="menu-3d-item w-full !py-0 hover:no-underline" data-testid="menu-collection">
                          Collection
                        </AccordionTrigger>
                        <AccordionContent className="pb-1 pt-3">
                          <div className="flex flex-col gap-2 pl-2">
                    ...
                    <SheetClose asChild>
                      <Link href="/contact">
                        <button className="menu-3d-item w-full flex items-center" data-testid="menu-contact">
                          <Mail className="mr-2.5 h-4 w-4" /> Contact
                        </button>
                      </Link>
                    </SheetClose>
                    <SheetClose asChild>
                      <Link href="/about">
                        <button className="menu-3d-item w-full flex items-center" data-testid="menu-about">
                          <Info className="mr-2.5 h-4 w-4" /> About
                        </button>
                      </Link>
                    </SheetClose>
                    ...
                    <SheetClose asChild>
                      <Link href="/cart">
                        <button className="menu-3d-item w-full flex items-center">
                          <ShoppingBag className="mr-2.5 h-4 w-4" /> My Cart ({totalItems})
                        </button>
                      </Link>
                    </SheetClose>
                    <SheetClose asChild>
                      <Link href="/settings">
                        <button className="menu-3d-item w-full flex items-center" data-testid="menu-settings">
                          <Settings className="mr-2.5 h-4 w-4" /> Settings
                        </button>
                      </Link>
                    </SheetClose>
                  ...
                  <SheetFooter className="border-t border-white/15 p-4">
                    {user ? (
                      <Button variant="outline" className="w-full text-white border-white/40 bg-white/10 hover:bg-white/20 hover:text-white [text-shadow:0_1px_3px_rgba(0,0,0,0.8)]" onClick={handleSignOut}>
                        <LogOut className="mr-2 h-4 w-4" /> Sign Out
                      </Button>
                    ) : (
                      <SheetClose asChild>
                        <Link href="/sign-in" className="w-full">
                          <Button variant="outline" className="w-full text-white border-white/40 bg-white/10 hover:bg-white/20 hover:text-white [text-shadow:0_1px_3px_rgba(0,0,0,0.8)]" data-testid="menu-login-account">
                            <LogIn className="mr-2 h-4 w-4" /> Log In
                          </Button>
                        </Link>
                      </SheetClose>
      ...
      <main className="relative flex-1 isolate">
        {/* Ambient atmosphere — soft metallic night glow */}
        <div aria-hidden className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
          <div
            className="absolute -top-[8%] -left-[8%] h-[60vh] w-[60vh] rounded-full opacity-30 blur-[140px] dark:opacity-20"
            style={{ background: "radial-gradient(circle, rgba(255,255,255,0.8) 0%, transparent 70%)" }}
          />
          <div
            className="absolute top-[35%] -right-[12%] h-[55vh] w-[55vh] rounded-full opacity-10 blur-[130px] dark:opacity-10"
            style={{ background: "radial-gradient(circle, rgba(200,200,200,0.5) 0%, transparent 70%)" }}
          />
          <div
            className="absolute bottom-[5%] left-[30%] h-[50vh] w-[50vh] rounded-full opacity-10 blur-[130px] dark:opacity-[0.08]"
            style={{ background: "radial-gradient(circle, rgba(220,220,220,0.4) 0%, transparent 70%)" }}
          />
        </div>
        {children}
      </main>
      ...
      <nav
        className="md:hidden animated-bottom-nav fixed bottom-0 left-0 right-0 z-50 bg-white/45 dark:bg-[#0a0a0a]/40 backdrop-blur-xl backdrop-saturate-150 border-t border-white/40 dark:border-white/15 safe-pb flex justify-around items-center px-4 h-16"
        style={{
          boxShadow:
            "inset 0 1px 0 rgba(255,255,255,0.55), 0 -8px 30px -8px rgba(0,0,0,0.25), 0 -2px 8px -2px rgba(0,0,0,0.12)",
          transform: "translateZ(0)",
          WebkitBackfaceVisibility: "hidden",
        }}
      >
        <Link href="/shop" className={`flex flex-col items-center justify-center w-full h-full space-y-1 ${location === "/shop" ? "text-black dark:text-white" : location.startsWith("/settings") ? "text-black/70" : "text-neutral-500 dark:text-neutral-400"}`}>
          <HomeIcon className="h-5 w-5" strokeWidth={location === "/shop" ? 2.5 : 1.5} />
          <span className="text-[10px] uppercase tracking-wider">Home</span>
        </Link>
        <Link href="/products" className={`flex flex-col items-center justify-center w-full h-full space-y-1 ${location.startsWith("/products") ? "text-black dark:text-white" : location.startsWith("/settings") ? "text-black/70" : "text-neutral-500 dark:text-neutral-400"}`}>
          <Store className="h-5 w-5" strokeWidth={location.startsWith("/products") ? 2.5 : 1.5} />
          <span className="text-[10px] uppercase tracking-wider">Shop</span>
        </Link>
        <Link href="/cart" className={`relative flex flex-col items-center justify-center w-full h-full space-y-1 ${location === "/cart" ? "text-black dark:text-white" : location.startsWith("/settings") ? "text-black/70" : "text-neutral-500 dark:text-neutral-400"}`} data-testid="mobile-nav-cart">
          <ShoppingBag className="h-5 w-5" strokeWidth={location === "/cart" ? 2.5 : 1.5} />
          {totalItems > 0 && (
            <span className="absolute top-1.5 right-6 sm:right-10 h-3.5 min-w-[14px] px-1 rounded-full bg-black text-white dark:bg-white dark:text-black text-[9px] font-bold flex items-center justify-center">
              {totalItems}
            </span>
          )}
          <span className="text-[10px] uppercase tracking-wider">Cart</span>
        </Link>
        <button onClick={() => setAccountMenuOpen(true)} className={`flex flex-col items-center justify-center w-full h-full space-y-1 ${location.startsWith("/settings") ? "text-black/70" : "text-neutral-500 dark:text-neutral-400"}`} data-testid="mobile-nav-account">
          <User className="h-5 w-5" strokeWidth={1.5} />
          <span className="text-[10px] uppercase tracking-wider">Account</span>
        </button>
      </nav>

      <footer className="relative mt-0 overflow-hidden bg-neutral-50 dark:bg-[#080808]">
        {/* Ambient glow blobs */}
        <div
          aria-hidden
          className="absolute top-[-10%] left-[-5%] h-[45vh] w-[45vh] rounded-full opacity-[0.05] blur-[120px] pointer-events-none"
          style={{ background: "radial-gradient(circle, #ffffff 0%, transparent 70%)" }}
        />
        <div
          aria-hidden
          className="absolute top-[20%] right-[-10%] h-[40vh] w-[40vh] rounded-full opacity-[0.05] blur-[110px] pointer-events-none"
          style={{ background: "radial-gradient(circle, #ffffff 0%, transparent 70%)" }}
        />
        <div
          aria-hidden
          className="absolute bottom-[-10%] left-[40%] h-[40vh] w-[40vh] rounded-full opacity-[0.03] blur-[110px] pointer-events-none"
          style={{ background: "radial-gradient(circle, #ffffff 0%, transparent 70%)" }}
        />
        {/* Top hairline */}
        <div
        ...
        <div className="relative container mx-auto px-5 pt-8 pb-6 md:pb-10 grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 text-sm">
          {/* Brand block */}
          <div className="col-span-2 md:col-span-1">
            <div
              className="font-serif uppercase tracking-[0.3em] mb-3 text-2xl text-black dark:text-white"
            >
              WOLFION
            </div>
          ...
          <div className="py-5 text-center text-xs text-neutral-600 dark:text-neutral-500 space-y-2">
            <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-2">
              ...
              <a
                ...
                className="hover:text-neutral-900 dark:hover:text-neutral-200 transition-colors"
                data-testid="footer-founder-link"
              >
                Md Rabby Bapari — Founder
              </a>
              <span className="text-neutral-400 dark:text-neutral-700">·</span>
              <a href="/app" className="hover:text-neutral-900 dark:hover:text-neutral-200 transition-colors">
                WOLFION App
              </a>
              <span className="text-neutral-400 dark:text-neutral-700">·</span>
              <a href="/socks" className="hover:text-neutral-900 dark:hover:text-neutral-200 transition-colors">
                Socks
              </a>
              <span className="text-neutral-400 dark:text-neutral-700">·</span>
              <a href="/manufacturing" className="hover:text-neutral-900 dark:hover:text-neutral-200 transition-colors">
                Manufacturing
              </a>
              <span className="text-neutral-400 dark:text-neutral-700">·</span>
              <a href="/services" className="hover:text-neutral-900 dark:hover:text-neutral-200 transition-colors">
                Services
              </a>
            </div>
            <div>
      ...
      <style>{`
        ...
        /* Fully transparent header floating over the hero on all
           screen sizes, like the editorial reference. No glass, no shadow. */
        .wf-shop-header,
        .dark .wf-shop-header {
