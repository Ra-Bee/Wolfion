    ...
    <div className="min-h-[100dvh] flex flex-col bg-white text-neutral-900 dark:bg-neutral-950 dark:text-neutral-50 antialiased font-sans">
      ...
      <footer className="relative mt-20 overflow-hidden bg-gradient-to-b from-neutral-50 to-white dark:from-neutral-950 dark:to-black">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(90deg, transparent 0%, rgba(26,187,196,0.5) 30%, rgba(15,76,92,0.5) 70%, transparent 100%)",
          }}
        />
        ...
        <div className="relative container mx-auto px-5 pt-14 pb-10 grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 text-sm">
          ...
          <div className="col-span-2 md:col-span-1">
            <div
              ...
              style={{
                background:
                  "linear-gradient(135deg, #1ABBC4 0%, #0E8B92 50%, #0F4C5C 100%)",
          ...
          {/* Collection links */}
          <div>
            <div className="text-[10px] uppercase tracking-[0.3em] text-[#0EA5B7] dark:text-[#67E8F0] mb-3 font-semibold">Collection</div>
            <ul className="space-y-2 text-neutral-700 dark:text-neutral-300">
              {COLLECTION_SUBCATS.map((s) => (
                <li key={s.path}>
                  <Link href={s.path} className="hover:text-[#0EA5B7] dark:hover:text-[#67E8F0] transition-colors">{s.label}</Link>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div className="col-span-2 md:col-span-1">
            <div className="text-[10px] uppercase tracking-[0.3em] text-[#0F4C5C] dark:text-[#A7F3F7] mb-3 font-semibold">Newsletter</div>
            ...
            <div className="relative">
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, #1ABBC4 0%, #0EA5B7 50%, #0F4C5C 100%)",
                }}
              />
              {/* Gradient ring */}
              <div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, rgba(26,187,196,0.6) 0%, rgba(14,165,183,0.4) 50%, rgba(15,76,92,0.6) 100%)",
                }}
              >
                <div
                ...
                >
                  ...
                  <Button
                    ...
                    style={{
                      background:
                        "linear-gradient(135deg, #1ABBC4 0%, #0EA5B7 60%, #0F4C5C 100%)",
                    }}
                  >
                    →
                  </Button>
              ...
              return (
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(135deg, rgba(26,187,196,0.5) 0%, rgba(14,165,183,0.4) 50%, rgba(15,76,92,0.5) 100%)",
                    }}
                  >
                    <div
        ...
        <div className="relative container mx-auto px-5 pb-10">
          <div className="relative max-w-3xl mx-auto">
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(135deg, rgba(26,187,196,0.4) 0%, rgba(14,165,183,0.3) 50%, rgba(15,76,92,0.4) 100%)",
              }}
            >
              <div
        ...
        <div className="relative">
          <div
            ...
            style={{
              background:
                "linear-gradient(90deg, transparent 0%, rgba(26,187,196,0.4) 30%, rgba(15,76,92,0.4) 70%, transparent 100%)",
            }}
          />
