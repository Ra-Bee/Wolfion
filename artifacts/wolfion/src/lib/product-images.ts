...
import footballBall from "@assets/wolfion/ptype-football-ball.png";
...
const PRODUCT_TYPE_IMAGES: Record<string, string> = {
  ...
  mixed,
  "sports-football": footballBall,
  "sports-football-combo": footballBall,
  "sports-football-top": sportsFootball,
  "sports-football-bottom": sportsFootball,
  others,
};
