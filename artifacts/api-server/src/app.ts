...
// Behind Render/Replit reverse proxies, req.ip is the proxy address unless
// we trust the X-Forwarded-For header. Needed for per-client rate limiting
// (otherwise all users share one bucket and can DoS each other's sign-ups).
